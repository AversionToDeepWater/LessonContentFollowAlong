import pygame
from LoadingSpriteSheetsTwo import SpriteSheet
...
dogtective_walk_left = SpriteSheet("logic/assets/images/characters/dogtective_sprite/Walk.png")
dogtective_walk_right = pygame.transform.flip(dogtective_walk_left, True, False) #flip animation on y axis?
dogtective_death = SpriteSheet("logic/assets/images/characters/dogtective_sprite/Death.png")
dogtective_idle = SpriteSheet("logic/assets/images/characters/dogtective_sprite/Idle.png")
dogtective_hurt = SpriteSheet("logic/assets/images/characters/dogtective_sprite/Hurt.png")
